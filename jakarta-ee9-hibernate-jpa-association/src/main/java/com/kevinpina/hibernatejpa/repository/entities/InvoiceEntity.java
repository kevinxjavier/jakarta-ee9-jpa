...
public class InvoiceEntity {
    ...
    // This relationship is bidirectional because it is also in defined in ClientEntity ass: @OneToMany List<InvoiceEntity> list,
    ...
    @ManyToOne // Many=.class To One=attribute (Many Invoices has One Client)
