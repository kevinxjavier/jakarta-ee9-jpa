...
public class ClientEntity {
	...
	@OneToMany(cascade = CascadeType.ALL, orphanRemoval = true) // One=.class To Many=attribute (One Client has Many Addresses ). Using Cascade means that this class is the principal in the relationship.
